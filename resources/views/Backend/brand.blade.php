        ...
        <div class="card-body">
            <form class="needs-validation"
                ...
                <div class="row">
                    <div class="col-md-6 mb-1">
                        ...
                        <input type="text" id="basic-addon-name" name='bname' class="form-control"
                            value="{{ isset($brandedit) ? $brandedit->name : '' }}" placeholder="brand Name" aria-label="Name"
                ...
                <div class="row">
                    ...
                    @if (isset($brand))
                        <div class="col-sm-6">
                            <img src="{{ asset('upload/brands') }}/{{ $brand->pic }}" class="bg-light-info" alt=""
                                    ...
                                    <div class="mb-1 breadcrumb-right">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <a class="dropdown-item" href=" {{ route('Backend.brand.destroy', $bid) }}"
